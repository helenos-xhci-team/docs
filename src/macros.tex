...
\newcommand{\file}[3][0]{\href{https://github.com/helenos-xhci-team/helenos/blob/master/#2\#L#1}{#3}}
\newcommand{\qemufile}[3][0]{\href{https://github.com/helenos-xhci-team/qemu/blob/master/#2\#L#1}{#3}}
