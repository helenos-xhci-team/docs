...
section describes the code structure and implementation details of the xHCI tranfer
subsystem.
...
error to the driver immediately, instead, the error that occured is returned with
