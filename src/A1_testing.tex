...
To use \texttt{usb-tmon}, first compile our version of QEMU that contains the \texttt{usb-tmon} driver:
...
Our work has been tested on a desktop with Teratren uDP720202 Rev. 1.0 PCIe card and on a ThinkPad x2?0 laptop with Intel FIXME controller. Regarding peripherials, several noname and branded USB2 and USB3 hubs, mice, keyboards, multi-endpoint keyboards (with multimedia keys) and flash drives have been tested.
