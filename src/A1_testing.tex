...
Similarly to that described in the previous section, this framework operates
mainly by means of shell scripts, sequentially executing instructions over the
QEMU Monitoring Protocol and disecting the kernel logs generated by the OS.
...
later only analyze logs with suspected failures, which constitue a much smaller
