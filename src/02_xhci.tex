...
and most of its contents are set accordingly to the contents of endpoint descriptor reported by the device.
...
The xHCI driver uses \struct{xhci_endpoint_t} for actual representation of the endpoint.
...
and the rationale behind it is described in the section \ref{sec:transfers}.
...
by putting TRBs on the endpoint's ring.
