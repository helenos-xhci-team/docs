...
\fnc{usb_dp_get_nested_descriptor} function takes parser, parser data and
...
and a pointer to the preceeding descriptor. Such pointer must always point to
